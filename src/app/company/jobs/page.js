        ...
        {jobs.map(job => (
          <div key={job._id} className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col relative overflow-hidden">
            ...
            <div className="pt-4 border-t border-slate-100 flex gap-2">
              ...
              <button className="flex-1 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-medium py-2 rounded-lg transition-colors text-sm border border-indigo-200">
                View Applicants
              </button>
