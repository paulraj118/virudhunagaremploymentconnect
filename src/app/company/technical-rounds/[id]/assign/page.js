      ...
      if (testDetails.jobId) {
        ...
        if (appData.success) {
          ...
          const eligibleCandidates = (appData.data?.applications || []).filter(app => {
            const validStage = ['Applied', 'Assessment Completed', 'Shortlisted'].includes(app.stage);
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        {candidates.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-slate-400 text-sm mt-1">Candidates must be in 'Applied' or 'Shortlisted' stages to receive assignments.</p>
          </div>
        ) : (
          <div>
