...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] font-sans">
      ...
      <section id="built-for-everyone" className="py-20 px-6 bg-[#F8F9FB]">
            ...
            <div>
              ...
              <ul className="space-y-3.5">
                {[
                  ...
                  { label: 'About', href: '#built-for-everyone', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
                  { label: 'Contact', href: 'mailto:tnemploymentconnect@gmail.com', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' }
                ].map((link, idx) => (
                  <li key={idx}>
                    <Link 
                      href={link.href} 
