...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex font-sans">
      ...
      <aside className="w-72 bg-linear-to-b from-slate-900 to-slate-800 text-white flex flex-col fixed h-full shadow-2xl">
      ...
      <main className="flex-1 ml-72 min-h-screen flex flex-col">
        ...
        <header className="bg-white h-16 border-b border-slate-200 flex items-center justify-between px-8 sticky top-0 z-20 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="bg-white hover:bg-slate-50 text-slate-700 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1.5 shadow-sm border border-slate-200">
            ...
            <Link href="/login" className="bg-white hover:bg-slate-50 text-slate-700 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1.5 shadow-sm border border-slate-200">
