      ...
      <main className="flex-1 md:ml-72 ml-0 min-h-screen flex flex-col">
        ...
        <header className="bg-white h-16 border-b border-slate-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-20 shadow-sm">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Link href="/login" className="bg-white hover:bg-slate-50 text-slate-700 px-2.5 py-1.5 md:px-3 md:py-1.5 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1 shadow-sm border border-slate-200">
