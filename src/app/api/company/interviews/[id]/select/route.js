...
export async function POST(request, { params }) {
  try {
    ...
    interview.timeline.push({
      ...
      remarks: remarks || 'Candidate selected after interview'
    });
    ...
    await AuditTrail.create({
      ...
      remarks: remarks || 'Final Decision - Selected'
    });
    ...
    await Notification.create({
      ...
      message: `Congratulations! You have been selected in the interview round (${interview.interviewRound}) for ${companyName}.`,
    ...
    console.error('[INTERVIEW_SELECT] Error:', error);
    return NextResponse.json(
